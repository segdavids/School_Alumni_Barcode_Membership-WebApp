<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/account/admin.Master" AutoEventWireup="true" CodeBehind="manage_shop_category.aspx.cs" Inherits="WebApp.Admin.manage_shop_category" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>DOBA2004 | Manage Categories</title>
</asp:Content>
       ...
       <!-- Page Content -->
        <div class="page-content">
                    ...
                    <div class="banner-content">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h3 class="item-title">Settings - Manage Categories</h3>
                ...
                <div class="block-box product-filter">
                    ...
                    <div id="contact-form">
                         <div class="filter-btn">
                            <a href="#header-search" style="margin-bottom:10px;color:brown" class="item-btn" >Add Category</a>
                        </div>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    <td><%#Container.ItemIndex+1 %>
                                                        <asp:Label ID="entrytxt" Visible="false" runat="server" Text='<%# Eval("CategoryId") %>' />
                                                    </td>
                                                    <td>
                                                         <asp:Label ID="titleidlbl" runat="server" Text='<%# Eval("CategoryName") %>'></asp:Label>
                                                        <asp:TextBox ID="TextBox1" class="form-control mb-4" type="text" Text='<%# Eval("CategoryName") %>' Visible="false" runat="server"></asp:TextBox>
                                                    </td>
            ...
            <div class="header-search-form">
                <input type="text" id="ranknametxt" runat="server" name="fname" placeholder="Category Name">
                    <asp:Button ID="Button1" runat="server" type="submit" OnClick="add_member" class="item-btn " style="color:brown;background-color:#f7d35c" Text="Add Category" />
            </div>
        </div>
