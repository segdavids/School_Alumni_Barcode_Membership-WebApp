<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/account/admin.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="manage_state.aspx.cs" Inherits="WebApp.Admin.manage_state" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <title>DOBA2004 | Manage States</title>
</asp:Content>
      ...
      <!-- Page Content -->
        <div class="page-content">
                    ...
                    <div class="banner-content">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h3 class="item-title">Settings - Manage State</h3>
                ...
                <div class="block-box post-input-tab">
                  ...
                  <div class="block-box user-top-header">
                    <ul class="menu-list">
                        ...
                        <li class="active"><a href="#">Edit state</a></li>
                ...
                <div class="block-box product-filter">
                    ...
                    <div id="contact-form">
                         <div class="filter-btn">
                            <a href="#header-search" style="margin-bottom:10px;color:brown" class="item-btn" >Add State</a>
                        </div>
                                ...
                                <table class="table table-bordered text-nowrap key-buttons">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-bottom-0">State Name</th>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    <td><%#Container.ItemIndex+1 %>
                                                        <asp:Label ID="entrytxt" Visible="false" runat="server" Text='<%# Eval("StateId") %>' />
                                                    </td>
                                                    <td>
                                                         <asp:Label ID="titleidlbl" runat="server" Text='<%# Eval("StateName") %>'></asp:Label>
                                                        <asp:TextBox ID="TextBox1" class="form-control mb-4" type="text" Text='<%# Eval("StateName") %>' Visible="false" runat="server"></asp:TextBox>
                                                    </td>
            ...
            <div class="header-search-form">
                <input type="text" id="ranknametxt" runat="server" name="fname" placeholder="State Name">
                    <asp:Button ID="Button1" runat="server" type="submit" OnClick="add_member" class="item-btn " style="color:brown;background-color:#f7d35c" Text="Add State" />
            </div>
        </div>
