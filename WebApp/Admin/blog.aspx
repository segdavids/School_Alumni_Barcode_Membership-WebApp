<%@ Page Title="" Language="C#" MaintainScrollPositionOnPostback="true" MasterPageFile="~/Admin/account/admin.Master" AutoEventWireup="true" CodeBehind="blog.aspx.cs" Inherits="WebApp.Admin.blog" %>
             ...
             <div class="block-box user-top-header">
                 ...
                 <div class="block-box product-filter">
                        ...
                        <div class="filter-btn">
                            <a href="/admin/add_blog" class="item-btn" style="color:brown">Add Blog</a>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <div class="block-box user-blog">
                                    ...
                                    <div class="blog-content">
                                        ...
                                        <div class="blog-date"><i class="icofont-calendar" style="color: brown"></i><%# Convert.ToDateTime(Eval("PostDate")).ToString("dd MMMM, yyyy") %> | <a href="edit_blog?bid=<%# Eval("BlogId") %>"><i class="icofont-edit" style="color:brown"></i>Edit</a>| <asp:LinkButton ID="LinkButton1" OnClientClick="return confirm('Delete this Blog Post?');" OnClick="Delete_Blog" runat="server"><i class="icofont-close-circled" style="color:brown"></i>Delete</asp:LinkButton></div>
